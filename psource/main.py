...
from ui.widgets.editor_menu import EditorMenu
from ui.widgets.table_tree_builder import TableTreeBuilder
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("TypeLens - OpenType Font Editor")
    ...
    def _init_ui(self):
        ...
        self._tree_view.selectionModel().currentChanged.connect(self._on_tree_selection_changed)
        ...
        self._tab_widget.addTab(self._glyph_panel, "Glyph")
    ...
    def _on_tree_selection_changed(self, current: QModelIndex, previous: QModelIndex):
        """
        Tree selection changed event (handles keyboard navigation)

        Args:
            current: Current selected index
            previous: Previous selected index
        """
