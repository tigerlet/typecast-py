...
class GlyphStatusBar(QStatusBar):
    ...
    def _init_widgets(self):
        ...
        self._glyph_label.setFrameStyle(QFrame.Shape.Panel | QFrame.Shadow.Sunken)
        self.addPermanentWidget(self._glyph_label)

        self._points_label = QLabel("Points: -")
        self._points_label.setFrameStyle(QFrame.Shape.Panel | QFrame.Shadow.Sunken)
        self.addPermanentWidget(self._points_label)

        self._contours_label = QLabel("Contours: -")
        self._contours_label.setFrameStyle(QFrame.Shape.Panel | QFrame.Shadow.Sunken)
        self.addPermanentWidget(self._contours_label)

        self._advance_label = QLabel("Advance: -")
        self._advance_label.setFrameStyle(QFrame.Shape.Panel | QFrame.Shadow.Sunken)
        self.addPermanentWidget(self._advance_label)

        self._lsb_label = QLabel("LSB: -")
        self._lsb_label.setFrameStyle(QFrame.Shape.Panel | QFrame.Shadow.Sunken)
